...
void RotationMatrixToEulerRadians(const Eigen::Matrix3f &R,
                                  Eigen::Vector3f *euler_rad);

// dcm2angle 'ZYX'
void EulerRadiansToRotationMatrix(const Eigen::Vector3f &euler_rad,
                                  Eigen::Matrix3f *R);

// Runge–Kutta 4th method for quaternion integration
// q_begin and q_end should be in the notation of L_q_W, where L is local
// coordinate,
// and W is world coordinate.  R(L_q_W) will be the top left 3x3 corner of T_LW,
// which
...
void IntegrateQuaternion(const Eigen::Vector3f &omega_begin,
                         ...
                         const Eigen::Quaternionf &q_begin, const float dt,
