...
class Configurator {
 public:
  ...
  inline int GetArgument(const std::string directive,
  ...
  inline float GetArgumentInverse(const std::string directive,
                                  const float default_val) const {
  ...
  inline float GetArgumentSquared(const std::string directive,
                                  const float default_val) const {
  ...
  inline float GetArgumentRadian(const std::string directive,
                                 const float default_val) const {
    return GetArgumentScaled(directive, default_val, UT_FACTOR_DEG_TO_RAD);
  }
  inline float GetArgumentRadianSquared(const std::string directive,
                                        const float default_val) const {
    return GetArgumentScaledSquared(directive, default_val,
                                    UT_FACTOR_DEG_TO_RAD);
  }
