...
class Camera {
   ...
   public:
    class Unitary {
     public:
      class CC {
       public:
        static inline CC Get(const LA::SymmetricMatrix6x6f &A,
                             const LA::Vector6f &b) {
          CC _A;
          _A.Set(A, b);
          return _A;
        }
        inline void Set(const LA::SymmetricMatrix6x6f &A,
                        const LA::Vector6f &b) {
          m_A = A;
          m_b = b;
        }
        ...
        inline void Increase3(const LA::SymmetricMatrix3x3f &A,
                              const LA::Vector3f &b) {
          m_A.Increase33(A);
          m_b.Increase345(b);
        }
        ...
        inline bool AssertEqual(const CC &A, const int verbose = 1,
          ...
          bool scc = true;
          scc =
              App1.AssertEqual(App2, verbose, str + ".m_App", epsAbs, epsRel) &&
              scc;
          scc =
              Apr1.AssertEqual(Apr2, verbose, str + ".m_Apr", epsAbs, epsRel) &&
              scc;
          scc =
              Arr1.AssertEqual(Arr2, verbose, str + ".m_Arr", epsAbs, epsRel) &&
              scc;
          scc = bp1.AssertEqual(bp2, verbose, str + ".m_bp", epsAbs, epsRel) &&
                scc;
          scc = br1.AssertEqual(br2, verbose, str + ".m_br", epsAbs, epsRel) &&
                scc;
          if (scc) {
            return true;
          } else if (verbose) {
        ...
        inline bool AssertZero(const int verbose = 1,
      ...
      class CM : public LA::AlignedMatrix6x9f {
       public:
        ...
        inline bool AssertEqual(const CM &A, const int verbose = 1,
          ...
          bool scc = true;
          scc =
              Apv1.AssertEqual(Apv2, verbose, str + ".m_Apv", epsAbs, epsRel) &&
              scc;
          scc = Apba1.AssertEqual(Apba2, verbose, str + ".m_Apba", epsAbs,
                                  epsRel) &&
                scc;
          scc = Apbw1.AssertEqual(Apbw2, verbose, str + ".m_Apbw", epsAbs,
                                  epsRel) &&
                scc;
          scc =
              Arv1.AssertEqual(Arv2, verbose, str + ".m_Arv", epsAbs, epsRel) &&
              scc;
          scc = Arba1.AssertEqual(Arba2, verbose, str + ".m_Arba", epsAbs,
                                  epsRel) &&
                scc;
          scc = Arbw1.AssertEqual(Arbw2, verbose, str + ".m_Arbw", epsAbs,
                                  epsRel) &&
                scc;
          if (scc) {
            return true;
      ...
      class MM {
       public:
        ...
        inline void Get(LA::AlignedMatrix9x9f *A,
                        LA::AlignedVector9f *b) const {
          A->Set(m_A);
          b->Set(m_b);
        }
        ...
        inline bool AssertEqual(const MM &A, const int verbose = 1,
          ...
          bool scc = true;
          scc =
              Avv1.AssertEqual(Avv2, verbose, str + ".m_Avv", epsAbs, epsRel) &&
              scc;
          scc = Avba1.AssertEqual(Avba2, verbose, str + ".m_Avba", epsAbs,
                                  epsRel) &&
                scc;
          scc = Avbw1.AssertEqual(Avbw2, verbose, str + ".m_Avbw", epsAbs,
                                  epsRel) &&
                scc;
          scc = Ababa1.AssertEqual(Ababa2, verbose, str + ".m_Ababa", epsAbs,
                                   epsRel) &&
                scc;
          scc = Ababw1.AssertEqual(Ababw2, verbose, str + ".m_Ababw", epsAbs,
                                   epsRel) &&
                scc;
          scc = Abwbw1.AssertEqual(Abwbw2, verbose, str + ".m_Abwbw", epsAbs,
                                   epsRel) &&
                scc;
          scc =
              bv1.AssertEqual(bv1, verbose, str + ".bv", epsAbs, epsRel) && scc;
          scc = bba1.AssertEqual(bba1, verbose, str + ".bba", epsAbs, epsRel) &&
                scc;
          scc = bbw1.AssertEqual(bbw1, verbose, str + ".bbw", epsAbs, epsRel) &&
                scc;
          if (scc) {
            return true;
          } else if (verbose) {
     ...
     public:
      ...
      inline bool AssertEqual(const Unitary &A, const int verbose = 1,
                              ...
                              const float epsRel = 0.0f) const {
        bool scc = true;
        scc = m_Acm.AssertEqual(A.m_Acm, verbose, str + ".m_Acm", epsAbs,
                                epsRel) &&
              scc;
        scc = m_Amm.AssertEqual(A.m_Amm, verbose, str + ".m_Amm", epsAbs,
                                epsRel) &&
              scc;
        return scc;
      }
    ...
    class Binary {
       ...
       public:
        ...
        inline bool AssertEqual(const CC &A, const int verbose = 1,
          ...
          scc =
              ...
              scc;
          scc =
              Arp1.AssertEqual(Arp2, verbose, str + ".m_Arp", epsAbs, epsRel) &&
              scc;
          scc =
              Arr1.AssertEqual(Arr2, verbose, str + ".m_Arr", epsAbs, epsRel) &&
              scc;
      ...
      class MC : public LA::AlignedMatrix9x6f {
       public:
        ...
        inline bool AssertEqual(const MC &A, const int verbose = 1,
          ...
          bool scc = true;
          scc =
              Avp1.AssertEqual(Avp2, verbose, str + ".m_Avp", epsAbs, epsRel) &&
              scc;
          scc = Abap1.AssertEqual(Abap2, verbose, str + ".m_Abap", epsAbs,
                                  epsRel) &&
                scc;
          scc = Abwp1.AssertEqual(Abwp2, verbose, str + ".m_Abwp", epsAbs,
                                  epsRel) &&
                scc;
          scc =
              Avr1.AssertEqual(Avr2, verbose, str + ".m_Avr", epsAbs, epsRel) &&
              scc;
          scc = Abar1.AssertEqual(Abar2, verbose, str + ".m_Abar", epsAbs,
                                  epsRel) &&
                scc;
          scc = Abwr1.AssertEqual(Abwr2, verbose, str + ".m_Abwr", epsAbs,
                                  epsRel) &&
                scc;
          if (scc) {
            return true;
      ...
      class MM : public LA::AlignedMatrix9x9f {
       public:
        ...
        inline bool AssertEqual(const MM &A, const int verbose = 1,
                                ...
                                const float epsAbs = 0.0f,
                                const float epsRel = 0.0f) const {
          LA::AlignedMatrix3x3f Avv1, Avba1, Avbw1, Abav1, Ababa1, Ababw1,
              Abwv1, Abwba1, Abwbw1;
          LA::AlignedMatrix3x3f Avv2, Avba2, Avbw2, Abav2, Ababa2, Ababw2,
              Abwv2, Abwba2, Abwbw2;
          ...
          scc = Avbw1.AssertEqual(Avbw2, verbose, str + ".m_Avbw", epsAbs,
                                  epsRel) &&
                scc;
          scc = Abav1.AssertEqual(Abav2, verbose, str + ".m_Abav", epsAbs,
                                  epsRel) &&
                scc;
          scc = Ababa1.AssertEqual(Ababa2, verbose, str + ".m_Ababa", epsAbs,
                                   epsRel) &&
          ...
          scc = Ababw1.AssertEqual(Ababw2, verbose, str + ".m_Ababw", epsAbs,
                                   epsRel) &&
                scc;
          scc = Abwv1.AssertEqual(Abwv2, verbose, str + ".m_Abwv", epsAbs,
                                  epsRel) &&
                scc;
          scc = Abwba1.AssertEqual(Abwba2, verbose, str + ".m_Abwba", epsAbs,
                                   epsRel) &&
                scc;
          scc = Abwbw1.AssertEqual(Abwbw2, verbose, str + ".m_Abwbw", epsAbs,
                                   epsRel) &&
     ...
     public:
      ...
      inline bool AssertEqual(const Binary &A, const int verbose = 1,
                              ...
                              const float epsRel = 0.0f) const {
        bool scc = true;
        scc = m_Acc.AssertEqual(A.m_Acc, verbose, str + ".m_Acc", epsAbs,
                                epsRel) &&
              scc;
        scc = m_Acm.AssertEqual(A.m_Acm, verbose, str + ".m_Acm", epsAbs,
                                epsRel) &&
              scc;
        scc = m_Amc.AssertEqual(A.m_Amc, verbose, str + ".m_Amc", epsAbs,
                                epsRel) &&
              scc;
        scc = m_Amm.AssertEqual(A.m_Amm, verbose, str + ".m_Amm", epsAbs,
                                epsRel) &&
...
#else
        m_Acm.AssertEqual(A.m_Acm.GetAlignedMatrix6x9f(), verbose,
                          str + ".m_Acm");
  ...
  class Fix {
   public:
    ...
    class Origin {
     public:
      ...
      class ES : public UT::ES<float, int> {
       public:
        ...
        inline void Accumulate(const Error &e, const float F,
                               const int iFrm = -1) {
      ...
      inline void Set(const float w, const LA::Vector3f &s2r, const float s2p,
                      const Rotation3D &R) {
      ...
      inline void GetFactor(const Rigid3D &T, Factor &A,
                            const float eps) const {
      ...
      inline void GetReduction(const Factor &A, const Rigid3D &T,
                               const LA::AlignedVector3f &xp,
                               const LA::AlignedVector3f &xr, Reduction &Ra,
     ...
     public:
      EigenErrorJacobian EigenGetErrorJacobian(const Rigid3D &T,
                                               const float eps) const;
     ...
     public:
      ...
      class ES {
       public:
        ...
        inline void AccumulateBiasAcceleration(const LA::AlignedVector3f &e,
                                               const float F,
                                               const int iFrm = -1) {
          m_ESba.Accumulate(ESError(e), F, iFrm);
        }
        inline void AccumulateBiasGyroscope(const LA::AlignedVector3f &e,
                                            const float F,
                                            const int iFrm = -1) {
 ...
 public:
  ...
  inline void AssertConsistency(const int verbose = 1,
                                const std::string str = "") const {
