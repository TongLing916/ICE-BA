...
class Keyboard {
 ...
 public:
  ...
  inline VALUE Get(const int key);
 ...
 protected:
  template <class KEY, class VALUE>
  static inline void Set(const KEY key, const VALUE &value,
  ...
  static inline void Set(const KEY key, const VALUE_TYPE &value,
                         std::map<KEY, VALUE> &map) {
#ifdef CFG_DEBUG
  ...
  template <class KEY, class VALUE>
  static inline const VALUE &Get(const KEY key,
...
template <>
inline void Keyboard::Set<int, int>(const int key, const int &value) {
  Set(key, value, m_mapSwitch);
}

template <>
inline bool Keyboard::Get<bool>(const int key) {
  return Get(key, m_mapBinary).m_value;
}
template <>
inline int Keyboard::Get<int>(const int key) {
