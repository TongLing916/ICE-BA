...
class AlignedMatrix2x3f {
 public:
  ...
  static inline AlignedMatrix2x3f GetRandom(const float mMin,
                                            const float mMax) {
    AlignedMatrix2x3f v;
    v.Random(mMin, mMax);
    return v;
  ...
  static inline void Ab(const AlignedMatrix2x3f &A, const AlignedVector3f &b,
                        float *Ab) {
    Ab[0] = (A.m_00_01_02_r0() * b.v012r()).vsum_012();
    Ab[1] = (A.m_10_11_12_r1() * b.v012r()).vsum_012();
  }
  static inline void AddAbTo(const AlignedMatrix2x3f &A,
  ...
  // static inline void AB(const SymmetricMatrix2x2f &A, const AlignedMatrix2x3f
  // &B1,
  ...
  //  A.m01();
  //  AB1.m_10_11_12_r1() = B1.m_00_01_02_r0() * A.m01() + B1.m_10_11_12_r1() *
  //  A.m11();
  //  AB2.m_00_01_02_r0() = B2.m_00_01_02_r0() * A.m00() + B2.m_10_11_12_r1() *
  //  A.m01();
  //  AB2.m_10_11_12_r1() = B2.m_00_01_02_r0() * A.m01() + B2.m_10_11_12_r1() *
  //  A.m11();
  //}
  ...
  static inline void ATb(const AlignedMatrix2x3f &A, const Vector2f &b,
                         AlignedVector3f &ATb) {
...
class Matrix2x3 {
 public:
  ...
  static inline void AddAbTo(const Matrix2x3<TYPE> &A, const AlignedVector3f &b,
                             float *Ab) {
...
template <>
inline void Matrix2x3f::Set(const AlignedMatrix2x3f &M) {
  memcpy(&m00(), &M.m00(), 12);
  memcpy(&m10(), &M.m10(), 12);
}
template <>
inline void Matrix2x3f::Get(AlignedMatrix2x3f &M) const {
  memcpy(&M.m00(), &m00(), 12);
  memcpy(&M.m10(), &m10(), 12);
}
}
...
class EigenMatrix2x3f : public Eigen::Matrix<float, 2, 3> {
 public:
  ...
  inline bool AssertEqual(const LA::AlignedMatrix2x3f &M, const int verbose = 1,
                          const std::string str = "", const float epsAbs = 0.0f,
                          const float epsRel = 0.0f) const {
  ...
  inline bool AssertEqual(const EigenMatrix2x3f &e_M, const int verbose = 1,
                          const std::string str = "", const float epsAbs = 0.0f,
                          const float epsRel = 0.0f) const {
    return AssertEqual(e_M.GetAlignedMatrix2x3f(), verbose, str, epsAbs,
                       epsRel);
  }
};
#endif
