...
class AlignedVector9f {
 public:
  ...
  inline void Get(AlignedVector3f &v0, AlignedVector3f &v1,
                  AlignedVector3f &v2) const {
    Get012(v0);
    Get345(v1);
    Get678(v2);
  }
  ...
  inline bool AssertEqual(const LA::AlignedVector9f &v, const int verbose = 1,
    ...
    if (UT::VectorAssertEqual(&v0(), &v.v0(), 9, verbose, str, epsAbs,
                              epsRel)) {
      return true;
    } else if (verbose) {
      UT::PrintSeparator();
...
class Vector9 {
 public:
  ...
  inline bool AssertEqual(const Vector9<TYPE> &v, const int verbose = 1,
    ...
    if (UT::VectorAssertEqual<TYPE>(&v0(), &v.v0(), 9, verbose, str, epsAbs,
                                    epsRel)) {
      return true;
    } else if (verbose) {
      UT::PrintSeparator();
  ...
  static inline void AbTo0(const AlignedMatrix3x3f &A, const AlignedVector3f &b,
                           Vector9<TYPE> &Ab) {
  ...
  static inline void AddAbTo0(const AlignedMatrix3x3f &A,
                              const AlignedVector3f &b, Vector9<TYPE> &Ab) {
    Ab.v0() += (A.m_00_01_02_r0() * b.v012r()).vsum_012();
    Ab.v1() += (A.m_10_11_12_r1() * b.v012r()).vsum_012();
    Ab.v2() += (A.m_20_21_22_r2() * b.v012r()).vsum_012();
  }
  static inline void AbTo3(const AlignedMatrix3x3f &A, const AlignedVector3f &b,
                           Vector9<TYPE> &Ab) {
  ...
  static inline void AbTo6(const AlignedMatrix3x3f &A, const AlignedVector3f &b,
                           Vector9<TYPE> &Ab) {
    Ab.v6() = (A.m_00_01_02_r0() * b.v012r()).vsum_012();
    Ab.v7() = (A.m_10_11_12_r1() * b.v012r()).vsum_012();
    Ab.v8() = (A.m_20_21_22_r2() * b.v012r()).vsum_012();
  }
  static inline void AddAbTo6(const AlignedMatrix3x3f &A,
                              const AlignedVector3f &b, Vector9<TYPE> &Ab) {
    Ab.v6() += (A.m_00_01_02_r0() * b.v012r()).vsum_012();
    Ab.v7() += (A.m_10_11_12_r1() * b.v012r()).vsum_012();
    Ab.v8() += (A.m_20_21_22_r2() * b.v012r()).vsum_012();
...
template <>
inline void Vector9f::Set(const float *v) {
  memcpy(this, v, sizeof(Vector9f));
}
template <>
inline void Vector9d::Set(const float *v) {
  for (int i = 0; i < 9; ++i) {
    m_data[i] = static_cast<double>(v[i]);
  }
}
template <>
inline void Vector9f::Set012(const float *v) {
  memcpy(&v0(), v, 12);
}
template <>
inline void Vector9f::Set345(const float *v) {
  memcpy(&v3(), v, 12);
}
template <>
inline void Vector9f::Set678(const float *v) {
  memcpy(&v6(), v, 12);
}
template <>
inline void Vector9d::Set012(const float *v) {
  v0() = static_cast<double>(v[0]);
  v1() = static_cast<double>(v[1]);
  v2() = static_cast<double>(v[2]);
}
template <>
inline void Vector9d::Set345(const float *v) {
  v3() = static_cast<double>(v[0]);
  v4() = static_cast<double>(v[1]);
  v5() = static_cast<double>(v[2]);
}
template <>
inline void Vector9d::Set678(const float *v) {
  v6() = static_cast<double>(v[0]);
  v7() = static_cast<double>(v[1]);
  v8() = static_cast<double>(v[2]);
}
template <>
inline void Vector9f::Get012(float *v) const {
  memcpy(v, &v0(), 12);
}
template <>
inline void Vector9f::Get345(float *v) const {
  memcpy(v, &v3(), 12);
}
template <>
inline void Vector9f::Get678(float *v) const {
  memcpy(v, &v6(), 12);
}
template <>
inline void Vector9d::Get012(float *v) const {
  v[0] = static_cast<float>(v0());
  v[1] = static_cast<float>(v1());
  v[2] = static_cast<float>(v2());
}
template <>
inline void Vector9d::Get345(float *v) const {
  v[0] = static_cast<float>(v3());
  v[1] = static_cast<float>(v4());
  v[2] = static_cast<float>(v5());
}
template <>
inline void Vector9d::Get678(float *v) const {
