...
class AlignedMatrix3x3f {
 public:
  ...
  inline bool GetInverseLDL(AlignedMatrix3x3f &MI,
  ...
  inline bool AssertEqual(const AlignedMatrix3x3f &M, const int verbose = 1,
    ...
    if (UT::VectorAssertEqual(&m00(), &M.m00(), 3, verbose, str, epsAbs,
                              epsRel) &&
        UT::VectorAssertEqual(&m10(), &M.m10(), 3, verbose, str, epsAbs,
                              epsRel) &&
        UT::VectorAssertEqual(&m20(), &M.m20(), 3, verbose, str, epsAbs,
                              epsRel)) {
      return true;
    } else if (verbose) {
      UT::PrintSeparator();
  ...
  static inline void AddsAToUpper(const xp128f &s, const AlignedMatrix3x3f &A,
                                  AlignedMatrix3x3f &sA) {
    sA.m_00_01_02_r0() += A.m_00_01_02_r0() * s;
    sA.m11() += A.m11() * s[0];
    sA.m12() += A.m12() * s[0];
  ...
  static inline void Ab_simd(const AlignedMatrix3x3f &A,
...
template <>
inline void Matrix3x3f::operator=(const AlignedMatrix3x3f &M) {
  memcpy(&m00(), &M.m00(), 12);
  memcpy(&m10(), &M.m10(), 12);
  memcpy(&m20(), &M.m20(), 12);
}
...
class SymmetricMatrix3x3 {
 public:
  ...
  inline bool GetInverse(AlignedMatrix3x3f &MI, const TYPE mMax = 0,
  ...
  static inline void AddATo(const SymmetricMatrix3x3<TYPE> &A,
                            AlignedMatrix3x3f &SA) {
    SA.m00() += A.m00();
    SA.m01() += A.m01();
    SA.m02() += A.m02();
...
template <>
inline void SymmetricMatrix3x3f::Set(const AlignedMatrix3x3f &M) {
  memcpy(&m00(), &M.m00(), 12);
  memcpy(&m11(), &M.m11(), 8);
  m22() = M.m22();
}
template <>
inline void SymmetricMatrix3x3d::Set(const AlignedMatrix3x3f &M) {
...
template <>
inline void SymmetricMatrix3x3f::SetRow0(const xp128f &v) {
  memcpy(&m00(), &v, 12);
}
template <>
inline void SymmetricMatrix3x3f::Get(SymmetricMatrix3x3f &M) const {
  M = *this;
}
template <>
inline void SymmetricMatrix3x3f::Get(SymmetricMatrix3x3d &M) const {
...
template <>
inline void SymmetricMatrix3x3d::Get(SymmetricMatrix3x3f &M) const {
...
template <>
inline void SymmetricMatrix3x3d::Get(SymmetricMatrix3x3d &M) const {
  M = *this;
}
template <>
...
class EigenMatrix3x3f : public Eigen::Matrix3f {
 public:
  ...
  inline bool AssertEqual(const LA::AlignedMatrix3x3f &M, const int verbose = 1,
                          const std::string str = "", const float epsAbs = 0.0f,
                          const float epsRel = 0.0f) const {
  ...
  inline bool AssertEqual(const LA::SymmetricMatrix3x3f &M,
                          ...
                          const float epsAbs = 0.0f,
                          const float epsRel = 0.0f) const {
    return GetAlignedMatrix3x3f().AssertEqual(M.GetAlignedMatrix3x3f(), verbose,
                                              str, epsAbs, epsRel);
  }
  inline bool AssertEqual(const EigenMatrix3x3f &e_M, const int verbose = 1,
                          const std::string str = "", const float epsAbs = 0.0f,
                          const float epsRel = 0.0f) const {
    return AssertEqual(e_M.GetAlignedMatrix3x3f(), verbose, str, epsAbs,
                       epsRel);
  }
  inline bool AssertZero(const int verbose = 1, const std::string str = "",
                         const float epsAbs = 0.0f,
